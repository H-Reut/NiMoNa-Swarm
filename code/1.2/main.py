...
for i in range(1,n+1):
    ...
    m = i
    p[i] = p[i-1] + dt * rk4(t[i-1], p[i-1], dt, behavior)
...
fixed_xmin_xmax_ymin_ymax  = fac * np.array([-1., 1., -1., 1.])
...
visualize_2d_ffmpeg(p, None, *fixed_xmin_xmax_ymin_ymax, True, T_max=T, dt=dt, inverse_arrow_scale_factor=10, img_save_path=img_save_path, fps=fps, delete_frames=True, show_plots=False, open_anim=True, draw_rectangle=[-10,10,-10,10], origin_color=None)
